 ...
 *  - LIBUSB_LOG_LEVEL_ERROR (1)   : error messages are printed to stder
 *  - LIBUSB_LOG_LEVEL_WARNING (2) : warning and error messages are printed to stder
 *  - LIBUSB_LOG_LEVEL_INFO (3)    : informational messages are printed to stdout, warning
 *    and error messages are printed to stder
 *  - LIBUSB_LOG_LEVEL_DEBUG (4)   : debug and informational messages are printed to stdout,
 *    warnings and errors to stder
 */
